...
pacman::p_load(dplyr, tibble, tidyr, stringr,readxl, ggplot2,ggsci, ggthemes, NormExpression, SoupX, scuttle, Seurat, scran, SeuratDisk, devtools, harmony, biomaRt, BiocManager, readr)
...
#load in saver data
#this is a matrix with cells as columns and rows as genes - cell names maintained. I'm going to remake the seurat so that the correct cells are present and add in the daver data from there
magic_df <- readr::read_csv("~/OneDrive - UW/data for deconv/Data matrices (C)/Gut/dataMAGIC/Correct CPM versions/df1_MAGIC.csv", col_names = TRUE)
magic_df <- t(magic_df)
...
#load in data
df <- readRDS("~/OneDrive - UW/data for deconv/CPM SEURAT OBJECTS/paper2_cpm.rds")

#load in saver data
#this is a matrix with cells as columns and rows as genes - cell names maintained. I'm going to remake the seurat so that the correct cells are present and add in the daver data from there
magic_df <- readr::read_csv("~/OneDrive - UW/data for deconv/Data matrices (C)/Gut/dataMAGIC/Correct CPM versions/df2_MAGIC.csv", col_names = TRUE)
...
write.table(pseudobulk, 
            file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/df2_MAGIC_pb1.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/df2_MAGIC_pb2.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/df2_MAGIC_pb3.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/df2_MAGIC_pb4.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/df2_MAGIC_pb5.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
#load in data
df <- readRDS("~/OneDrive - UW/data for deconv/CPM SEURAT OBJECTS/paper3_cpm.rds")

#load in saver data
#this is a matrix with cells as columns and rows as genes - cell names maintained. I'm going to remake the seurat so that the correct cells are present and add in the daver data from there
magic_df <- readr::read_csv("~/OneDrive - UW/data for deconv/Data matrices (C)/Gut/dataMAGIC/df3_MAGIC.csv", col_names = TRUE)
magic_df <- t(as.matrix(magic_df))
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/Paper3_MAGIC_pseudobulk_1.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/Paper3_MAGIC_pseudobulk_2.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/Paper3_MAGIC_pseudobulk_3.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/Paper3_MAGIC_pseudobulk_4.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/pseudobulks (E)/Pseudobulks/Paper3_MAGIC_pseudobulk_5.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
