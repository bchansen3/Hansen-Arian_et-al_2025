...
h_infant_124 <- readRDS("~/Documents/h_infant_124.rds")
...
magic_hi124 <- fread("~/Documents/magic_sqrt_updated_41925/hi124_MAGIC_matrix_SQRT.csv")%>% t()
colnames(magic_hi124) <- magic_hi124[1,]
magic_hi124 <- magic_hi124[-1,]


mgc_pseudo <- as.matrix(magic_hi124[,cells_for_pseudo])
...
lg <- data.frame(samp2(pseudo, 12, 23, "Leydig")@assays$magic$data)
germ <- data.frame(samp2(pseudo, 13, 23, "Germ")@assays$magic$data)
ptm <- data.frame(samp2(pseudo, 13, 23, "PTM")@assays$magic$data)
endo <- data.frame(samp2(pseudo, 12, 23, "Endo")@assays$magic$data)
srt <- data.frame(samp2(pseudo, 450, 23, "Sertoli")@assays$magic$data)
...
write.table(pseudobulk, file = "~/Documents/MAGIC_T_04202025/h124_out/H_I-124_MAGIC_SRT90.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)


#2 75% Sertoli cells (252 cells)
lg <- data.frame(samp2(pseudo, 50, 23, "Leydig")@assays$magic$data)
germ <- data.frame(samp2(pseudo, 50, 23, "Germ")@assays$magic$data)
ptm <- data.frame(samp2(pseudo, 50, 23, "PTM")@assays$magic$data)
endo <- data.frame(samp2(pseudo, 50, 23, "Endo")@assays$magic$data)
srt <- data.frame(samp2(pseudo, 450, 23, "Sertoli")@assays$magic$data)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h124_out/H_I-124_MAGIC_SRT75.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)


#2 50% Sertoli cells
lg <- data.frame(samp2(pseudo, 63, 23, "Leydig")@assays$magic$data)
germ <- data.frame(samp2(pseudo, 62, 23, "Germ")@assays$magic$data)
ptm <- data.frame(samp2(pseudo, 63, 23, "PTM")@assays$magic$data)
endo <- data.frame(samp2(pseudo, 62, 23, "Endo")@assays$magic$data)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h124_out/H_I-124_MAGIC_SRT50.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)


#2 25% Sertoli cells 252 cells
lg <- data.frame(samp2(pseudo, 99, 23, "Leydig")@assays$magic$data)
germ <- data.frame(samp2(pseudo, 80, 23, "Germ")@assays$magic$data)
ptm <- data.frame(samp2(pseudo, 98, 23, "PTM")@assays$magic$data)
endo <- data.frame(samp2(pseudo, 98, 23, "Endo")@assays$magic$data)
srt <- data.frame(samp2(pseudo, 125, 23, "Sertoli")@assays$magic$data)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h124_out/H_I-124_SAVER_SRT25.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)

#5 10% Sertoli cells
lg <- data.frame(samp2(pseudo, 124, 23, "Leydig")@assays$magic$data)
germ <- data.frame(samp2(pseudo, 80, 23, "Germ")@assays$magic$data)
ptm <- data.frame(samp2(pseudo, 123, 23, "PTM")@assays$magic$data)
endo <- data.frame(samp2(pseudo, 123, 23, "Endo")@assays$magic$data)
srt <- data.frame(samp2(pseudo, 50, 23, "Sertoli")@assays$magic$data)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h124_out/H_I-124_SAVER_SRT10.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
df_samp[["magic"]] <- CreateAssayObject(data = magic_ref)
...
write.table(cell_ref, 
            file = "~/Documents/MAGIC_T_04202025/h124_out/h_i_124_MAGIC_REF.txt", 
