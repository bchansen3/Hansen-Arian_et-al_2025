...
h_infant_120 <- readRDS("~/Documents/h_infant_120.rds")
...
magic_hi120 <- fread("~/Documents/magic_sqrt_updated_41925/hi120_MAGIC_matrix_SQRT.csv")%>% t()
...
write.table(pseudobulk, file = "~/Documents/MAGIC_T_04202025/h120_out/H_I-120_MAGIC_SRT90.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h120_out/H_I-120_MAGIC_SRT75.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h120_out/H_I-120_MAGIC_SRT50.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h120_out/H_I-120_MAGIC_SRT25.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/h120_out/H_I-120_MAGIC_SRT10.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(cell_ref, 
            file = "~/Documents/MAGIC_T_04202025/h120_out/h_i_120_MAGIC_Ref.txt", 
