...
m_neonate_d2 <- readRDS("~/Documents/m_neonateD2.rds")
...
magic_mn2 <- fread("~/Documents/magic_sqrt_updated_41925/mn2_MAGIC_matrix_SQRT.csv")%>% t()
colnames(magic_mn2) <- magic_mn2[1,]
magic_mn2 <- magic_mn2[-1,]


mn2_mgc_pseudo <- magic_mn2[,cells_for_pseudo]

saveRDS(mn2_mgc_pseudo, "mn2_mgc_pseudo.rds")


pseudo[["magic"]] <- CreateAssayObject(data = mn2_mgc_pseudo)


sampmagic <- magic_mn2[, !(colnames(magic_mn2) %in% cells_for_pseudo)]
...
write.table(pseudobulk, file = "~/Documents/MAGIC_T_04202025/mn2_out/m_neo_d2_MAGIC_srt90.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/Documents/MAGIC_T_04202025/mn2_out/m_neo_d2_MAGIC_srt75.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/Documents/MAGIC_T_04202025/mn2_out/m_neo_d2_MAGIC_srt50.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file =  "~/Documents/MAGIC_T_04202025/mn2_out/m_neo_d2_MAGIC_srt25.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/Documents/MAGIC_T_04202025/mn2_out/m_neo_d2_MAGIC_srt10.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(cell_ref, 
            file = "~/Documents/MAGIC_T_04202025/mn2_out/m_neo_d2_MAGIC.txt", 
