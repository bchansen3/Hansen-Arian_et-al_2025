...
write.table(cell_ref, 
            file = "~/OneDrive - UW/data for deconv/Testis_cellRefs/h_a_112.txt", 
...
#1 90% Leydig cells
lg <- data.frame(samp2(pseudo, 450, 23, "Leydig")@assays$ALRA$counts)
...
write.table(cell_ref, 
            file = "~/OneDrive - UW/data for deconv/Testis_cellRefs/h_a_112_ALRA.txt", 
            sep = "\t", quote=FALSE, row.names = FALSE, col.names = F)
...
write.table(cell_ref, 
            file = "~/OneDrive - UW/data for deconv/Testis_cellRefs/h_a_112_SVR.txt", 
            sep = "\t", quote=FALSE, row.names = FALSE, col.names = F)
...
write.table(cell_ref, 
            file = "~/OneDrive - UW/data for deconv/Testis_cellRefs/h_a_112_MAGIC.txt", 
            sep = "\t", quote=FALSE, row.names = FALSE, col.names = F)
