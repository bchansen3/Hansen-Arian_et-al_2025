...
m_neonate_d7 <- readRDS("~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/objectsforcounts_50825/m_neonateD7.rds")
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/md7/m_neo_d7_COUNTS_srt90.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/md7/m_neo_d7_COUNTS_srt75.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/md7/m_neo_d7_COUNTS_srt50.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file =  "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/md7/m_neo_d7_COUNTS_srt25.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/md7/m_neo_d7_COUNTS_srt10.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(cell_ref, 
            file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/m_neo_d7_COUNTS.txt", 
