...
h_adult_112 <- readRDS("~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/objectsforcounts_50825/h_adult_112.rds")
...
#1 90% Leydig cells
lg <- data.frame(samp2(pseudo, 450, 23, "Leydig")@assays$RNA$counts)
dspg <- data.frame(samp2(pseudo, 10, 23, "d_spg")@assays$RNA$counts)
ptm <- data.frame(samp2(pseudo, 10, 23, "PTM")@assays$RNA$counts)
ssc <- data.frame(samp2(pseudo, 10, 23, "SSCs")@assays$RNA$counts)
spc <- data.frame(samp2(pseudo, 10, 23, "meiosis_spcs")@assays$RNA$counts)
srt <- data.frame(samp2(pseudo, 10, 23, "Sertoli")@assays$RNA$counts)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/h112/adult112_COUNTS_lg90.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)


#2 75% Leydig cells
lg <- data.frame(samp2(pseudo, 375, 23, "Leydig")@assays$RNA$counts)
dspg <- data.frame(samp2(pseudo, 25, 23, "d_spg")@assays$RNA$counts)
ptm <- data.frame(samp2(pseudo, 25, 23, "PTM")@assays$RNA$counts)
ssc <- data.frame(samp2(pseudo, 25, 23, "SSCs")@assays$RNA$counts)
spc <- data.frame(samp2(pseudo, 25, 23, "meiosis_spcs")@assays$RNA$counts)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/h112/adult112_COUNTS_lg75.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)


#2 50% Leydig cells
lg <- data.frame(samp2(pseudo, 250, 23, "Leydig")@assays$RNA$counts)
dspg <- data.frame(samp2(pseudo, 50, 23, "d_spg")@assays$RNA$counts)
ptm <- data.frame(samp2(pseudo, 50, 23, "PTM")@assays$RNA$counts)
ssc <- data.frame(samp2(pseudo, 51, 23, "SSCs")@assays$RNA$counts)
spc <- data.frame(samp2(pseudo, 50, 23, "meiosis_spcs")@assays$RNA$counts)
srt <- data.frame(samp2(pseudo, 49, 23, "Sertoli")@assays$RNA$counts)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/h112/adult112_COUNTS_lg50.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)


#2 25% Leydig cells
lg <- data.frame(samp2(pseudo, 125, 23, "Leydig")@assays$RNA$counts)
dspg <- data.frame(samp2(pseudo, 81, 23, "d_spg")@assays$RNA$counts)
ptm <- data.frame(samp2(pseudo, 81, 23, "PTM")@assays$RNA$counts)
ssc <- data.frame(samp2(pseudo, 82, 23, "SSCs")@assays$RNA$counts)
spc <- data.frame(samp2(pseudo, 82, 23, "meiosis_spcs")@assays$RNA$counts)
srt <- data.frame(samp2(pseudo, 49, 23, "Sertoli")@assays$RNA$counts)
...
write.table(pseudobulk, file =  "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/h112/adult112_COUNTS_lg25.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)


#5 10% Leydig cells
lg <- data.frame(samp2(pseudo, 50, 23, "Leydig")@assays$RNA$counts)
dspg <- data.frame(samp2(pseudo, 101, 23, "d_spg")@assays$RNA$counts)
ptm <- data.frame(samp2(pseudo, 100, 23, "PTM")@assays$RNA$counts)
ssc <- data.frame(samp2(pseudo, 100, 23, "SSCs")@assays$RNA$counts)
spc <- data.frame(samp2(pseudo, 100, 23, "meiosis_spcs")@assays$RNA$counts)
srt <- data.frame(samp2(pseudo, 49, 23, "Sertoli")@assays$RNA$counts)
...
write.table(pseudobulk, file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/PBs/h112/adult112_COUNTS_lg10.txt", sep = "\t", quote=FALSE, row.names = FALSE, col.names = TRUE)
...
write.table(cell_ref, 
            file = "~/OneDrive - UW/data for deconv/Paper revision materials/DATA/raw_counts/TESTIS/h_a_112_COUNTS_Ref.txt", 
